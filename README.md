...
* [Generator](https://doc.qt.io/qtforpython/shiboken6/shibokengenerator.html): Extract information from C or C++ headers and generate [CPython](https://github.com/python/cpython) ⭐ 75,981 | 🐛 9,642 | 🌐 Python | 📅 2026-09-04 code that allow to bring C or C++ projects to Python. This process uses a library called [ApiExtractor](https://doc.qt.io/qtforpython/shiboken6/typesystem.html) which internally uses [Clang](https://clang.llvm.org/).

* [Module](https://doc.qt.io/qtforpython/shiboken6/shibokenmodule.html): An utility Python module that exposed new Python types, functions to handle pointers, among other things, that is written in [CPython](https://github.com/python/cpython) ⭐ 75,981 | 🐛 9,642 | 🌐 Python | 📅 2026-09-04 and can use independently of the generator.
...
[WayfireWM](https://github.com/WayfireWM/wayfire) ⭐ 3,044 | 🐛 119 | 🌐 C++ | 📅 2026-09-05 is a 3D Wayland compositor, inspired by [Compiz](https://launchpad.net/compiz) and based on [wlroots](https://github.com/swaywm/wlroots) ⚠️ Archived.
...
[x11docker](https://github.com/mviereck/x11docker) ⭐ 6,308 | 🐛 31 | 🌐 Shell | 📅 2026-07-05 is an application that you allows to run graphical desktop applications (and entire desktops) in Docker Linux containers.
...
[Wayland-rs](https://github.com/Smithay/wayland-rs) ⭐ 1,423 | 🐛 80 | 🌐 Rust | 📅 2026-08-28 is a Rust implementation of the wayland protocol (client and server).
